...
final class CatagoryCollectionViewController: UICollectionViewController {
	...
	private var categoryMenuTitles = CatagoryMenuTitles()
...
//		}
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
		...
		switch(row) {
		case CatagoryMenuOrder.All.rawValue:
			 cell.menuItemName.text = categoryMenuTitles.title(.All)
		case CatagoryMenuOrder.Monuments.rawValue:
			cell.menuItemName.text = categoryMenuTitles.title(.Monuments)
		case CatagoryMenuOrder.Murals.rawValue:
			cell.menuItemName.text = categoryMenuTitles.title(.Murals)
		case CatagoryMenuOrder.Plagues.rawValue:
			cell.menuItemName.text = categoryMenuTitles.title(.Plagues)
		case CatagoryMenuOrder.Sculpture.rawValue:
			cell.menuItemName.text = categoryMenuTitles.title(.Sculpture)
		case CatagoryMenuOrder.Statues.rawValue:
			cell.menuItemName.text = categoryMenuTitles.title(.Statues)
		case CatagoryMenuOrder.StreetArt.rawValue:
			cell.menuItemName.text = categoryMenuTitles.title(.StreetArt)
		default:
